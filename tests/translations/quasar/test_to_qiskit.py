...
def test_translate_quasar_to_qiskit(quasar_circuit):
    ...
    quasar_transpilation_circuit = quasar_dialect.native_to_circuit(quasar_circuit)
    ...
    qiskit_native_circuit = qiskit_dialect.circuit_to_native(qiskit_transpiled_circuit)
